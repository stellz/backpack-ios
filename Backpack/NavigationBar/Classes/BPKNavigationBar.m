...
@property(nonatomic) CGFloat baseScrollOffset;
...
- (void)setUpForScrollview:(UIScrollView *)scrollView {
    ...
    self.baseScrollOffset = [self calculateScrollOffset:scrollView];
}

- (CGFloat)calculateScrollOffset:(UIScrollView *)scrollView {
...
- (void)updateWithScrollView:(UIScrollView *)scrollView {
    CGFloat adjustedYOffset = [self calculateScrollOffset:scrollView];
...
- (CGFloat)fontSizeForScrollOffset:(CGFloat)offset {
    CGFloat netOffset = fabs(self.baseScrollOffset - offset);
